...
class m010101_010102_storage_menu extends Migration
{
    ...
    public function up()
    {
        ...
        $this->batchInsert('menu_item', ['id_item', 'label', 'slug', 'type', 'style', 'data', 'sort', 'id_menu', 'name_auth', 'id_user', 'date_create', 'date_update'], [
            [NULL, 'Storage', 'storage', '1', '{"icon":"","color":"","iconSize":"","display":false,"childDisplay":false}', '{"data":{"route":"\\/storage\\/default\\/index","module":null}}', '14', $id_menu, 'storageWebDefaultIndex', 1, '2022-06-13 15:32:26', '2022-06-13 15:32:26'],
        ]);
