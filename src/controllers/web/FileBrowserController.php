...
class FileBrowserController extends Controller
{
    ...
    /**
     * Updates an existing Storage model via Pjax.
     * This method handles file uploads and updates the model attributes accordingly.
     * It checks user permissions before allowing the update and returns a JSON response.
     *
     * @param int $id Id Storage
     * @return string JSON response with the updated file name or error message
     * @throws NotFoundHttpException if the model cannot be found
     */
