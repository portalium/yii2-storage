...
<?php if ($view == 1) { ?>
    ...
    <div id="w2" class="card file-picker-card " onclick="selectCheckbox(event)" style="display: flex; flex-direction: column;">
        <div class="card-header" style="align-items:center; overflow: auto;position: absolute;width: 100%;background: #fafafa; opacity: 0.8; display:flex; justify-content:space-between; width: 100%; ">
            <div class="panel-title w-100">
                ...
                <div class="actions" style="display: flex; gap:5px;  justify-content:end">
                    <?php
